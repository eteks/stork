$(function(e) {
    ...
    updateTheBirthDayValue = function(e, a, t, r, n) {
        ...
        $birthday = e("<input class='birthDay' name='" + l + "_birthDay' type='hidden' value='2004-01-01'/>"), i.placeholder && "bigEndian" == i.dateFormat ? o.append(d).append(p).append(s) : "littleEndian" == i.dateFormat ? o.append(s).append(p).append(d) : o.append(p).append(s).append(d);
        var h = r - i.minAge,
            c = r - i.maxAge;
