		...
		<!--Account main content : Begin -->
					<section class="account-main col-md-9 col-sm-8 col-xs-12">
						...
						<div class="form-edit-info">
							...
							<form action="edit_paper_print_type.php" id="edit_paper_print_type" method="POST" name="edit-acc-info">
								
								<div class="form-group">
								    <label for="last-name">Paper Printtype<span class="required">*</span></label>
									<input type="text" class="form-control" id="first-name" placeholder="Paper Printtype<">
								</div>
