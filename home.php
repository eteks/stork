				...
				<div class="vt-slideshow">
					<ul>
						<li class="slide1" data-transition="random" ><img src="images/slider/home/Print2.jpg" alt="project_binding" width="1920px" height="598px"/>
							...
							<div style="background-color:#000; opacity:0.6;padding: 20px;" class="tp-caption lfr" data-x="left" data-y="367" data-start="1300" data-speed="2000" data-easing="easeInOutQuint" data-endspeed="300">Offer Title: 123A456B. <em>Vaild till 29 July 2016.</em></div>
						</li>
			...
			<div class="container">
				<div class="row">
					...
					<ul class="slider-w slider-owl">
						...
						<li class="pro-item">
							<div class="product-image-action">
								<img src="images/product/263x263/2.jpg" alt="New Brochures">
								<div class="action">
						...
						<li class="pro-item">
							<div class="product-image-action">
								<img src="images/product/263x263/3.jpg" alt="Flyers Two Page">
								<div class="action">
									<button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
										<i class="fa fa-shopping-cart"></i> 
									</button>
							...
							<div class="product-info">
								<a href="detail.html" title="product" class="product-name">Flyers Two Page</a> 
								<div class="price-box">
									<span class="special-price">$ 12.98</span>
									<span class="old-price">$ 16.98</span> 
								</div>
								<div class="rating-box">  
									<i class="fa fa-star"></i>
									<i class="fa fa-star"></i>
						...
						<li class="pro-item">
							<div class="product-image-action">
								<img src="images/product/263x263/4.jpg" alt="Business Card">
								<div class="action">
									<button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
										<i class="fa fa-shopping-cart"></i> 
									</button>
							...
							<div class="product-info">
								<a href="detail.html" title="product" class="product-name">Business Card</a> 
								<div class="price-box">
									<span class="normal-price">$ 9.80</span>
								</div>
								<div class="rating-box">  
						...
						<li class="pro-item">
							<div class="product-image-action">
								<img src="images/product/263x263/eSliproser-postcard.jpg" alt="eSliproser Postcards">
								<div class="action">
									<button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
										<i class="fa fa-shopping-cart"></i> 
									</button>
							...
							<div class="product-info">
								<a href="detail.html" title="product" class="product-name">eSliproser Postcards</a> 
								<div class="price-box">
						...
						<li class="pro-item">
							<div class="product-image-action">
								<img src="images/product/263x263/holiday-postcard-2.jpg" alt="Holiday Postcard 2">
								<div class="action">
									<button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
										<i class="fa fa-shopping-cart"></i> 
									</button>
							...
							<div class="product-info">
								<a href="detail.html" title="product" class="product-name">Holiday Postcard 2</a> 
								<div class="price-box">
									<span class="normal-price">$ 10.09</span>
								</div>
									<div class="rating-box">  
						...
						<li class="pro-item">
							<div class="product-image-action">
								<img src="images/product/263x263/postcard-mailing-services.jpg" alt="Postcard Mailing Services">
								<div class="action">
									<button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
										<i class="fa fa-shopping-cart"></i> 
									</button>
							...
							<div class="product-info">
								<a href="detail.html" title="product" class="product-name">Postcard Mailing Services</a> 
								<div class="price-box">
									<span class="normal-price">$ 10.09</span>
								</div>
								<div class="rating-box">  
						...
						<li class="pro-item">
							<div class="product-image-action">
								<img src="images/product/263x263/holiday-postcard.jpg" alt="Holiday Postcard">
								<div class="action">
									<button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
										<i class="fa fa-shopping-cart"></i> 
									</button>
							...
							<div class="product-info">
								<a href="detail.html" title="product" class="product-name">Holiday Postcard</a> 
								<div class="price-box">
									<span class="normal-price">$ 10.09</span>
								</div>
								<div class="rating-box">  
						...
						<li class="pro-item">
							<div class="product-image-action">
								<img src="images/product/263x263/new-business-card.jpg" alt="New Business Card">
								<div class="action">
									<button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
										<i class="fa fa-shopping-cart"></i> 
									</button>
							...
							<div class="product-info">
								<a href="detail.html" title="product" class="product-name">New Business Card</a> 
								<div class="price-box">
									<span class="normal-price">$ 9.80</span>
								</div>
								<div class="rating-box">  
						...
						<li class="pro-item">
							<div class="product-image-action">
								<img src="images/product/263x263/holiday-postcard-3.jpg" alt="Holiday Postcard 3">
								<div class="action">
									<button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
										<i class="fa fa-shopping-cart"></i> 
									</button>
					...
					<div class="tab-content">
						<div class="tab-pane active" id="tab1">	
							...
							<div class="col-md-6 col-sm-8 hidden-xs">
								<div class="pro-item large-item">
									<div class="product-image-action">
										<img src="images/product/business-card-large-item.jpg" alt="Grouper Business card">
										<div class="action">
											<button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
												<i class="fa fa-shopping-cart"></i> 
											</button>
									...
									<div class="product-info">
										...
										<a class="view-more" href="detail.html" title="view more product">
											View more
										</a>
									</div>
								</div>
							</div><!--New Products Large Item : End -->
							<!--New Products Item Col1 : Begin -->
							<div class="col-md-3 col-sm-4">
								<div class="pro-item visible-xs">
									<div class="product-image-action">
										<img src="images/product/263x263/business-card-2.jpg" alt="Business card 2">
										<div class="action">
											<button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
												<i class="fa fa-shopping-cart"></i> 
											</button>
									...
									<div class="product-info">
										<a href="detail.html" title="product" class="product-name">Business card 2</a>
										<div class="rating-box">  
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
							...
							</div><!--New Products Item Col1 : End -->
							<!--New Products Item Col2 : Begin -->
							<div class="col-md-3 visible-md visible-lg">
								<div class="pro-item">
									<div class="product-image-action">
										<img src="images/product/263x263/new-postcard-card.jpg" alt="New Postcard Cards">
										<div class="action">
											<button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
												<i class="fa fa-shopping-cart"></i> 
											</button>
									...
									<div class="product-info">
										<a href="detail.html" title="product" class="product-name">New Postcard Cards</a>
										<div class="rating-box">  
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
											<i class="fa fa-star-half-o"></i>
							...
							</div><!--New Products Item Col2 : End --> 
						</div>
						<div class="tab-pane" id="tab2">	
							...
							<div class="col-md-6 col-sm-8 hidden-xs">
								<div class="pro-item large-item">
									...
									<div class="product-info">
										...
										<a class="view-more" href="detail.html" title="view more product">View more</a>
									</div>
								</div>
							</div><!--New Products Large Item : End -->
							<!--New Products Item Col1 : Begin -->
							...
							<div class="col-md-3 visible-md visible-lg">
								<div class="pro-item">
									<div class="product-image-action">
										<img src="images/product/263x263/grouper-business-card.jpg" alt="New Postcard Cards">
										<div class="action">
											<button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
												<i class="fa fa-shopping-cart"></i> 
											</button>
								...
								<div class="pro-item">
									<div class="product-image-action">
										<img src="images/product/263x263/flyers-two-page.jpg" alt="Postcard Mailing Services">
										<div class="action">
											<button type="button" data-toggle="tooltip" data-placement="top"  class="add-to-cart gbtn" title="Add to cart">
												<i class="fa fa-shopping-cart"></i> 
											</button>
