...
if (isset($_GET['update']))
{
	if ($_SERVER['REQUEST_METHOD'] == 'POST' ){
		...
		if($row > 0){
			$successMessage = "<div class='alert alert-success'><li class='fa fa-check-square-o'></li><b> Paperprinttype Already exists</b></div>";	
		} else {
			...
			$successMessage = "<div class='alert alert-success'><li class='fa fa-check-square-o'></li><b> Paperprinttype Updated Successfully.</b></div>";	
		}
...
<title>Edit Paperprinttype: <?php echo(getTitle()) ?></title>
</head>
<body>
	...
	<div class="container" style="margin-top:20px;">
		...
		<div class="mainy">
			...
			<div class="page-title">
				<h2><i class="fa fa-pencil-square color"></i> Edit Paperprinttype </h2> 
				<hr />
			</div>
			<!-- Page title -->
			<div class="row">
				<div class="awidget">
					<form class="form-horizontal edit_paperprinttype" role="form" action="edit_paper_print_type.php?update=<?php echo $id; ?>" method="post">
					<?php 
					...
					if ($numRows > 0)
					{
						...
						?>
							<div class="form-group">
								<label class="col-lg-2 control-label">Paper printtype</label><span>*</span>
								<div class="col-lg-10">
									<input type="text" id="edit_paperprintform" class="form-control" name="paper_print_type" value="<?php echo($row['paper_print_type']); ?>"/>
								</div>
							</div>
							<div class="form-group">
								<label class="col-lg-2 control-label">Paperprinttype status</label><span>*</span>
								<div class="col-lg-10">
									<select class="form-control" name="paper_print_type_status">
