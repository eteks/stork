	...
	if (isset($_GET['update']))
	{
		if ($_SERVER['REQUEST_METHOD'] == 'POST' ){
			...
			if($row > 0){
				...
				mysqlQuery("UPDATE `stork_offer_details` SET offer_type='$offer_type_value',offer_title='$offer_title',offer_code='$offer_code',offer_user_type='$offer_user_type_value',offer_validity_start_date= '$offer_start_validity',offer_validity_end_date='$offer_end_validity',offer_amount_type='$offer_amount_type_value',offer_amount='$offer_amount',offer_eligible_amount='$offer_eligible_amount',offer_usage_limit='$offer_limitation',offer_status='$offer_status' WHERE `offer_id`=".$val);
