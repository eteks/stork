      ...
      <div>
        <tr>
          <td>
            ...
            <!-- Callout Panel -->
            <p class="callout">
              We will send you another email once the items in your order have been shipped.Meanwhile,you can check the status of your order on Printstork.com
            </p><!-- /Callout Panel -->                        
            <!-- social & contact -->
              <tr>
                <td>                  
                  ...
                  <table align="center" class="column">
                    <tr>
                      <td>                                       
                        ...
                        <p>Phone: <strong>9655707844,8428380001</strong><br/>
                        Email: <strong><a href="emailto:support@printstork.com">support@printstork.com</a></strong></p>                
                      </td>
                    </tr>
                  </table><!-- /column 2 -->                  
