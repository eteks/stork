...
<div class="page-content blocky">
	<div class="container" style="margin-top:20px;">
		...
		<div class="mainy">
			...
			<div class="row">
				<div class="awidget">
					<form class="form-horizontal edit_offer_zone" role="form" action="edit_state.php?update=<?php echo $id; ?>" method="post">
					<span class="error_offer_zone"> Please fill out required fields </span>
					<?php 
