...
<head>
	<meta charset="utf-8">
	<title>Printing theme - Checkout page</title>
			   ...
			   <h3 class="title"><span class="icon icon-one">1</span>BILLING INFO</h3>
				<div class="pane-inner">
				  <ul id="table_billto" class="adminform user-details no-border">
					...
					<li class="short">
     				 <div class="field-wrapper">
    					<label for="middle_name_field" class="middle_name">Middle Name</label>
						<br>
					...
					<li class="short right">
     				  <div class="field-wrapper">
						<label for="last_name_field" class="last_name">Last Name</label>
						<br>
					...
					<li class="short right">
   					  <div class="field-wrapper">
						<label for="virtuemart_country_id_field" class="virtuemart_country_id">Country<em>*</em></label>
						<br>
					...
					<li class="short right">
    				  <div class="field-wrapper">
						<label for="virtuemart_state_id_field" class="virtuemart_state_id">State / Province / Region<em>*</em></label>
						<br>
					...
					<li class="long">
					 ...
					 <li class="long">
					   <div class="field-wrapper">
     						<label for="fax_field" class="fax">Fax</label>
							<br>
